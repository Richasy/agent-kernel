...
/// </summary>
public sealed partial class AzureTranslateClient(AzureTranslateServiceConfig config) : ITranslateClient
{
    ...
    private readonly AzureTranslateServiceConfig? _config = config;

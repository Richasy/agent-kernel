...
/// </remarks>
public sealed partial class AliTranslateClient(AliTranslateServiceConfig config) : ITranslateClient
{
    ...
    private readonly AliTranslateServiceConfig? _config = config;

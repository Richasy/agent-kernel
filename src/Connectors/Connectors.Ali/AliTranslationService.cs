...
public sealed class AliTranslationService : ITextTranslationService, IHtmlTranslationService
{
    ...
    /// </summary>
    public AliTranslationService() => _httpClient = HttpExtensions.CreateHttpClient();
    ...
    private static HttpRequestMessage CreateRequest(string url, Dictionary<string, string> formData, string ak_id, string ak_secret)
    {
        ...
        System.Diagnostics.Debug.WriteLine("hashedBody: \n" + hashedBody);
        ...
        System.Diagnostics.Debug.WriteLine("canonicalHeaders: \n" + canonicalHeaders);
        var signedHeaders = "content-type;host;x-acs-action;x-acs-content-sha256;x-acs-date;x-acs-signature-nonce;x-acs-version";
        System.Diagnostics.Debug.WriteLine("signedHeaders: \n" + signedHeaders);
        var canonicalRequest =
            ...
            signedHeaders + "\n" +
            hashedBody;
        System.Diagnostics.Debug.WriteLine("canonicalRequest: \n" + canonicalRequest);

...
public partial class ChatCompletion
{
    ...
    /// <summary> The additional raw data of the message. </summary>
    public Dictionary<string, BinaryData> ContentAdditionalRawData => Choices[0].Message.SerializedAdditionalRawData.ToDictionary();

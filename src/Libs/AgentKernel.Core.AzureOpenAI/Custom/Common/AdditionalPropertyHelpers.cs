...
internal static class AdditionalPropertyHelpers
{
        ...
        where T : class, IJsonModel<T>
    {
        ...
        //{
        //    items.Add((T)ModelReaderWriter.Read(BinaryData.FromObjectAsJson(element, SourceGenerationContext.Default.JsonElement), typeof(T)));
        //}
        return items;
    }
    ...
    internal static void SetEmptySentinelValue(IDictionary<string, BinaryData> additionalProperties, string key)
    {
        ...
        additionalProperties[key] = BinaryData.FromObjectAsJson(SARD_EMPTY_SENTINEL, SourceGenerationContext.Default.String);
    }

...
public static class McpClientExtensions
{
    ...
    private static JsonRpcRequest CreateRequest(string method, Dictionary<string, object?>? parameters)
    {
        ...
        {
            Method = method,
            Params = parameters is null ? null : BinaryData.FromString(JsonSerializer.Serialize(parameters, JsonSerializerOptionsExtensions.JsonContext.Default.DictionaryStringObject)),
        };
    } 

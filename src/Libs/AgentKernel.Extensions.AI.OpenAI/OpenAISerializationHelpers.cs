...
{
    /// <summary>
    /// Deserializes a chat completion request in the OpenAI wire format into a pair of <see cref="Microsoft.Extensions.AI.ChatMessage"/> and <see cref="ChatOptions"/> values.
    /// </summary>
    ...
    public static async Task SerializeAsync(
        Stream stream,
        Microsoft.Extensions.AI.ChatCompletion chatCompletion,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        Core.OpenAI.Chat.ChatCompletion openAiChatCompletion = OpenAIModelMappers.ToOpenAIChatCompletion(chatCompletion, options);
    ...
    public static Task SerializeStreamingAsync(
        Stream stream,
        IAsyncEnumerable<Microsoft.Extensions.AI.StreamingChatCompletionUpdate> streamingChatCompletionUpdates,
        JsonSerializerOptions? options = null,
        CancellationToken cancellationToken = default)
    {
        _ = Throw.IfNull(stream);
        ...
        static async IAsyncEnumerable<SseItem<BinaryData>> ToSseEventsAsync(IAsyncEnumerable<Core.OpenAI.Chat.StreamingChatCompletionUpdate> updates)
        {

...
public sealed class OpenAIEmbeddingGenerator : IEmbeddingGenerator<string, Embedding<float>>
{
    ...
    {
        Core.OpenAI.Embeddings.EmbeddingGenerationOptions? openAIOptions = ToOpenAIOptions(options);
    ...
    private Core.OpenAI.Embeddings.EmbeddingGenerationOptions? ToOpenAIOptions(Microsoft.Extensions.AI.EmbeddingGenerationOptions? options)
    {
        Core.OpenAI.Embeddings.EmbeddingGenerationOptions openAIOptions = new()
        {

...
internal static partial class OpenAIModelMappers
{
    ...
    public static IEnumerable<Microsoft.Extensions.AI.ChatMessage> FromOpenAIChatMessages(IEnumerable<Core.OpenAI.Chat.ChatMessage> inputs)
    {
...
#pragma warning restore CA1031 // Do not catch general exception types
                ...
                case AssistantChatMessage assistantMessage:
                    ...
                    Microsoft.Extensions.AI.ChatMessage message = new()
                    {
    ...
    public static IEnumerable<Core.OpenAI.Chat.ChatMessage> ToOpenAIChatMessages(IEnumerable<Microsoft.Extensions.AI.ChatMessage> inputs, JsonSerializerOptions options)
    {
...
#pragma warning disable S3011 // Reflection should not be used to increase accessibility of classes, methods, or fields
    private static readonly Func<ChatCompletionOptions, IList<Core.OpenAI.Chat.ChatMessage>> _getMessagesAccessor =
        (Func<ChatCompletionOptions, IList<Core.OpenAI.Chat.ChatMessage>>)
            typeof(ChatCompletionOptions).GetMethod("get_Messages", BindingFlags.NonPublic | BindingFlags.Instance)!
            .CreateDelegate(typeof(Func<ChatCompletionOptions, IList<Core.OpenAI.Chat.ChatMessage>>))!;
